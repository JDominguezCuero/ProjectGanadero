{{-- resources/views/productos/partials/registrar_producto.blade.php --}}
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                {{-- Acción de guardado: usa la ruta resource 'productos.store' --}}
                <form action="{{ route('productos.store') }}" method="POST" id="formRegistroProducto" enctype="multipart/form-data">
                    @csrf
