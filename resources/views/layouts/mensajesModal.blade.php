...
<script>
// La función JavaScript se mantiene igual ya que depende de Bootstrap JS
function showModal(title, message, type = 'info') {
    ...
    // En un entorno Laravel/Blade moderno, verifica si usas Bootstrap 4 (jQuery) o 5 (Vanilla JS)
    // Aquí se asume que tienes Bootstrap JS cargado.
